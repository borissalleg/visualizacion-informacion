...
=== "Proximidad"
    ...
    Los elementos cercanos entre sí se perciben como un grupo. Se usa para agrupar
    puntos de una misma categoría en un gráfico de dispersión sin necesidad de
    encerrarlos en un recuadro.

=== "Similitud"

    Elementos con el mismo color, forma o tamaño se perciben como pertenecientes al
    mismo grupo, incluso si están distantes. Es la base de la codificación por
    color en leyendas.

=== "Continuidad"

    El ojo sigue líneas y curvas suaves antes que trazos abruptos. Por eso una
    serie de tiempo se lee más fácilmente como una línea continua que como puntos
    aislados.

=== "Cierre"

    El cerebro completa formas incompletas. Permite simplificar gráficos (por
    ejemplo, un gráfico de radar) sin necesidad de dibujar todos los contornos.

=== "Figura-fondo"

    Distinguimos automáticamente un objeto (figura) de su entorno (fondo). Un buen
    contraste entre las marcas de datos y el fondo del gráfico mejora la
    legibilidad.
...
### 2.3 Buenas y malas prácticas: chartjunk y data-ink ratio
...
### Ejemplo 1 — Comparando canales visuales (posición vs. ángulo)
...
### Ejemplo 2 — Data-ink ratio: antes y después
