...
### 2.2 Patrón de lectura en F (F-pattern)
...
## 3. Ejemplo: dashboard en Power BI (paso a paso descrito)
...
## 4. Ejemplo equivalente en Python con Streamlit
