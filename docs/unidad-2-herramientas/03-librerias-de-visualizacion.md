...
## 1. Panorama de librerías de visualización
...
## 2. Ejemplo comparativo: el mismo gráfico en 3 librerías

A continuación se construye el mismo gráfico (dispersión de esperanza de vida vs.
PIB per cápita, con tamaño de burbuja proporcional a la población, usando el
dataset `gapminder`-like sintético) con **Matplotlib**, **Seaborn** y **Plotly**,
